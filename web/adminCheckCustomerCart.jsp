    ...
    <body>
        <div class="w3-bar w3-white w3-card" id="myNavbar">
            ...
            <div class="w3-right w3-hide-small">
                ...
                <a href="${pageContext.request.contextPath}/adminviewschedule" class="w3-bar-item w3-button"><i class="fa fa-search"></i> View Flight</a>  
            ...
            <form action="checkcart" method="post">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                        <br/><br/>
                        <c:forEach items="${checkcart}" var="c">
                            ...
                            <tr bgcolor="#F5F5F5">
                                ...
                                <td scope="col">${c.customerID.customerName}</td>
                                ...
                                <td>
                                    <c:if test="${c.status eq 1}">
                                        <button class="btn btn-primary" name="mod" value="5">Confirm</button>
                                        <button class="btn btn-danger" name="mod" value="6">Reject</button>
                                    </c:if>
                                    <c:if test="${c.status eq 2 || c.status eq 3 || c.status eq 4}">
                                        <button class="btn btn-danger" name="mod" value="7" >Delete</button>
                                    </c:if>
                                </td>
                            </tr>
                            <input type="hidden" name="id" value="${c.bookingID}">
                            <input type="hidden" name="ticketid" value="${c.tid.ticketID}"
                        </c:forEach>
                        </tbody>
                    </table>
