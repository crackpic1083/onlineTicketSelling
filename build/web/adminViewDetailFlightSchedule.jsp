    ...
    <body>
        ...
        <section class="container-fluid bg">
            <section class="row justify-content-center">
                ...
                <form action="adminviewdetailschedule" method="post">
                    <div class="col-sm-3 col-md-3" style="margin-left: 400px; margin-top: 20px">
                        <div class="form-group">
                            ...
                            <div class="flight-name-container">
                                ...
                                <input readonly type="number" id="fname" name="fname" value="${flightName}" class="form-control" placeholder="Flight Name" required>
                            </div>
                        ...
                        <div class="input-field">
                            ...
                            <select name="arname" class="form-control" required>
                                <c:forEach items="${ar}" var="a">
                                    <option value="${a.aircraftID}" <c:if test="${a.aircraftID eq f.aircraftID.aircraftID}">selected="selected"</c:if>>${a.aircraftName}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="selectedCity"  value="${f.arrivalCity}">
                        ...
                        <div class="input-field">
                            ...
                            <input type="datetime-local" class="form-control" value="${f.arrivalTime}" required name="arrtime">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="selectedCity1"  value="${f.departureCity}">
                        ...
                        <div class="input-field">
                            ...
                            <input type="datetime-local" name="detime" value="${f.departureTime}" required class="form-control" >
                        ...
                        <div class="input-field">
                            <label>Admin Name Create</label>
                            <input readonly type="text" name="namecreate" value="${f.createBy.adminName}" required class="form-control">
                        </div>

                        <div class="input-field">
                            <label>Create Date</label>
                            <input readonly type="datetime-local" name="createdate" required class="form-control" value="${f.createDate}">
                        </div>

                        <div class="input-field">
                            <label>Admin Name Update</label>
                            <input readonly type="text" name="nameupdate" required class="form-control" value="${f.updateBy.adminName}">
                        </div>

                        <div class="input-field">
                            <label>Update Date</label>
                            <input  readonly type="datetime-local" name="updatedate" required class="form-control" value="${f.upgradeDate}">
                        </div>

                        <div class="input-field">
                            <label>Total Flight Ticket</label>
                            <input readonly type="text" name="totalticket" required class="form-control" value="${aticket}">
                        </div>
                    ...
                    <div class="col-sm-3 col-md-3" style="margin-left: 30px" >
                        ...
                        <div class="form-group plane " style="margin-left: 30px;" >
                            <div class="exit"></div>
                            <table style="margin-left: 30px; margin-top: 90px;">
                                <c:forEach items="${seats}" var="s" varStatus="status">
                                    ...
                                    <li class="seat">
                                        <input type="checkbox" value="${s}" name="seatname${s}" id="${s}"
                                               ...
                                               /> 
                                        <label for="${s}" <c:forEach items="${tickets}" var="ti" >
                                                   <c:if test="${ti.seatName eq s}">
                        ...
                        <div class="input-field">
                            <label>Number Of Booked Ticket</label>
                            <input readonly type="text" name="bookedticket" required class="form-control" value="${bticket}">
                        </div>

                        <div class="input-field">
                            <label>Ticket Price</label>
                            <input type="number" name="price" required class="form-control" value="${f.price}">
                        ...
                        <div class="input-field" style="margin-top: 32px">
                            <button type="submit" class="btn btn-success btn-block form-control" name="mod" value="update">Update</button>
                            <button type="submit" class="btn btn-danger btn-block form-control" name="mod" value="delete">Delete</button>
                        </div>  
                    </div>
                </form>
