    ...
    <body>
        ...
        <section class="container-fluid bg">
            <section class="row justify-content-center">
                ...
                <form action="book" method="post" class="form-container" style="margin-left: 380px; ">
                    <div class="col-sm-3 col-md-3">

                        <div class="form-group">
                            <label for="pname">Passenger Name</label>
                            <input type="text" class="form-control" id="pname" name="name" value="${name}" placeholder="Enter name of the/any passenger(s)" required >
                                ...
                                <c:forEach items="${seats}" var="s" varStatus="status">
                                    ...
                                    <c:if test="${status.index % 6 == 0}">
                                        ...
                                        <td>
                                            ...
                                            <li class="seat">
                                                <input type="radio" required name="seat" value="${t.ticketID}" id="${s}"/> 
                                                <label for="${s}">${s}</label>
                                            </li>
                                        </c:if>
                                    </c:forEach>
